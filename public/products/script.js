  ...
  renderRow(item, index, category, subcategory) {
    ...
    return `
      <div class="table-row" data-product-row="${category}-${subcategory}-${index}">
        ...
        <div class="table-data" style="display: flex;flex-direction:column; width: 3rem; text-align: center;"><span style=" align-self:center">${weightIcons}</span> <span>${item.weight || "N/A"}kg</span></div>
        <div class="table-data">
